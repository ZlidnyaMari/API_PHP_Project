...
use Gb\Php2\Repositories\InMemoryUsersRepository;
use Gb\Php2\UnitTests\Container\SomeClassWithParameter;
use Gb\Php2\UnitTests\Container\ClassDependingOnAnother;
...
class DIContainerTest extends TestCase
{
    public function testItThrowsAnExceptionIfCannotResolveType(): void
    {
        ...
        $this->expectExceptionMessage(
            'Cannot resolve type: Gb\Php2\UnitTests\Container\SomeClass'
        );
